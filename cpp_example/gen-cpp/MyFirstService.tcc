...
uint32_t MyFirstService_ping_args::read(Protocol_* iprot) {
...
template <class Protocol_>
uint32_t MyFirstService_ping_args::write(Protocol_* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("MyFirstService_ping_args");
...
template <class Protocol_>
uint32_t MyFirstService_ping_pargs::write(Protocol_* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("MyFirstService_ping_pargs");
...
template <class Protocol_>
uint32_t MyFirstService_ping_result::read(Protocol_* iprot) {
...
template <class Protocol_>
uint32_t MyFirstService_ping_result::write(Protocol_* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("MyFirstService_ping_result");
...
template <class Protocol_>
uint32_t MyFirstService_ping_presult::read(Protocol_* iprot) {
...
template <class Protocol_>
uint32_t MyFirstService_send_binary_args::read(Protocol_* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readBinary(this->blob);
          this->__isset.blob = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
template <class Protocol_>
uint32_t MyFirstService_send_binary_args::write(Protocol_* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("MyFirstService_send_binary_args");

  xfer += oprot->writeFieldBegin("blob", ::apache::thrift::protocol::T_STRING, 1);
  xfer += oprot->writeBinary(this->blob);
  xfer += oprot->writeFieldEnd();
...
template <class Protocol_>
uint32_t MyFirstService_send_binary_pargs::write(Protocol_* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("MyFirstService_send_binary_pargs");
...
template <class Protocol_>
void MyFirstServiceClientT<Protocol_>::ping()
{
  send_ping();
  recv_ping();
}
...
template <class Protocol_>
void MyFirstServiceClientT<Protocol_>::send_ping()
{
  int32_t cseqid = 0;
  this->oprot_->writeMessageBegin("ping", ::apache::thrift::protocol::T_CALL, cseqid);

  MyFirstService_ping_pargs args;
...
template <class Protocol_>
void MyFirstServiceClientT<Protocol_>::recv_ping()
{
  ...
  MyFirstService_ping_presult result;
...
template <class Protocol_>
int32_t MyFirstServiceClientT<Protocol_>::multiply(const int32_t number1, const int32_t number2)
{
...
template <class Protocol_>
void MyFirstServiceClientT<Protocol_>::send_multiply(const int32_t number1, const int32_t number2)
{
  int32_t cseqid = 0;
...
template <class Protocol_>
int32_t MyFirstServiceClientT<Protocol_>::recv_multiply()
{
...
template <class Protocol_>
int32_t MyFirstServiceClientT<Protocol_>::get_log_size(const std::string& filename)
{
...
template <class Protocol_>
int32_t MyFirstServiceClientT<Protocol_>::recv_get_log_size()
{
...
template <class Protocol_>
void MyFirstServiceClientT<Protocol_>::send_binary(const std::string& blob, const std::string& filename)
{
  send_send_binary(blob, filename);
}

template <class Protocol_>
void MyFirstServiceClientT<Protocol_>::send_send_binary(const std::string& blob, const std::string& filename)
{
  int32_t cseqid = 0;
  this->oprot_->writeMessageBegin("send_binary", ::apache::thrift::protocol::T_ONEWAY, cseqid);

  MyFirstService_send_binary_pargs args;
  args.blob = &blob;
  args.filename = &filename;
  args.write(this->oprot_);
...
template <class Protocol_>
void MyFirstServiceProcessorT<Protocol_>::process_ping(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("MyFirstService.ping", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "MyFirstService.ping");

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preRead(ctx, "MyFirstService.ping");
  }

  MyFirstService_ping_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postRead(ctx, "MyFirstService.ping", bytes);
  }

  MyFirstService_ping_result result;
  try {
    iface_->ping();
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != nullptr) {
      this->eventHandler_->handlerError(ctx, "MyFirstService.ping");
    }
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preWrite(ctx, "MyFirstService.ping");
  }
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postWrite(ctx, "MyFirstService.ping", bytes);
  }
}

template <class Protocol_>
void MyFirstServiceProcessorT<Protocol_>::process_ping(int32_t seqid, Protocol_* iprot, Protocol_* oprot, void* callContext)
{
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("MyFirstService.ping", callContext);
...
template <class Protocol_>
void MyFirstServiceProcessorT<Protocol_>::process_send_binary(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  (void) seqid;
  (void) oprot;
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("MyFirstService.send_binary", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "MyFirstService.send_binary");

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preRead(ctx, "MyFirstService.send_binary");
  }

  MyFirstService_send_binary_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postRead(ctx, "MyFirstService.send_binary", bytes);
  }

  try {
    iface_->send_binary(args.blob, args.filename);
  } catch (const std::exception&) {
    if (this->eventHandler_.get() != nullptr) {
      this->eventHandler_->handlerError(ctx, "MyFirstService.send_binary");
    }
    return;
  }

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->asyncComplete(ctx, "MyFirstService.send_binary");
  }
...
template <class Protocol_>
void MyFirstServiceProcessorT<Protocol_>::process_send_binary(int32_t, Protocol_* iprot, Protocol_*, void* callContext)
{
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("MyFirstService.send_binary", callContext);
...
template <class Protocol_>
::std::shared_ptr< ::apache::thrift::TProcessor > MyFirstServiceProcessorFactoryT<Protocol_>::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< MyFirstServiceIfFactory > cleanup(handlerFactory_);
  ::std::shared_ptr< MyFirstServiceIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::std::shared_ptr< ::apache::thrift::TProcessor > processor(new MyFirstServiceProcessorT<Protocol_>(handler));
  return processor;
}

template <class Protocol_>
void MyFirstServiceConcurrentClientT<Protocol_>::ping()
{
...
template <class Protocol_>
int32_t MyFirstServiceConcurrentClientT<Protocol_>::send_ping()
{
...
template <class Protocol_>
void MyFirstServiceConcurrentClientT<Protocol_>::recv_ping(const int32_t seqid)
{
...
template <class Protocol_>
int32_t MyFirstServiceConcurrentClientT<Protocol_>::multiply(const int32_t number1, const int32_t number2)
{
...
template <class Protocol_>
int32_t MyFirstServiceConcurrentClientT<Protocol_>::send_multiply(const int32_t number1, const int32_t number2)
{
  int32_t cseqid = this->sync_->generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  this->oprot_->writeMessageBegin("multiply", ::apache::thrift::protocol::T_CALL, cseqid);
...
template <class Protocol_>
int32_t MyFirstServiceConcurrentClientT<Protocol_>::recv_multiply(const int32_t seqid)
{
...
template <class Protocol_>
int32_t MyFirstServiceConcurrentClientT<Protocol_>::get_log_size(const std::string& filename)
{
...
template <class Protocol_>
int32_t MyFirstServiceConcurrentClientT<Protocol_>::recv_get_log_size(const int32_t seqid)
{
...
template <class Protocol_>
void MyFirstServiceConcurrentClientT<Protocol_>::send_binary(const std::string& blob, const std::string& filename)
{
  send_send_binary(blob, filename);
}

template <class Protocol_>
void MyFirstServiceConcurrentClientT<Protocol_>::send_send_binary(const std::string& blob, const std::string& filename)
{
  int32_t cseqid = 0;
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  this->oprot_->writeMessageBegin("send_binary", ::apache::thrift::protocol::T_ONEWAY, cseqid);
